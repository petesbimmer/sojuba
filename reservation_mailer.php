<?php
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        if ( empty($name) OR empty($phone) OR empty($time)  OR empty($date) OR empty($table_no) OR empty($message) OR !filter_var($email, FILTER_VALIDATE_EMAIL)) {
		...
		$email_content .= "Table No: $table_no\n";
